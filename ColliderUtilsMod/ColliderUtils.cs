...
{
    public Dictionary<string, string> ReplacementColliderComponent = new()
    {
    ...
    public Dictionary<string, string> SetupBoundsType = new()
    {
        { "None", "None" },
    ...
    public Dictionary<string, string> UseTagMode = new()
    {
        { "IgnoreTag", "IgnoreTag" },
    ...
    public static ValueField<colorX> HighlightColor;
    ...
    {
        _Wizard = this;
        WizardSlot = Engine.Current.WorldManager.FocusedWorld.RootSlot.AddSlot("Collider Wizard");
    ...
    private void Awake(Slot Data)
    {
        ...
        HighlightColor = Data.AddSlot("HighlightColor").AttachComponent<ValueField<colorX>>();
        HighlightColor.Value.Value = new colorX(1f, 1f, 1f);
    ...
    private void Attach(Slot Data)
    {
        ...
        Data.Name = "Collider Management Wizard";
        Data.Tag = "Developer";
        LegacyCanvasPanel resoniteCanvasPanel = Data.AttachComponent<LegacyCanvasPanel>();
        resoniteCanvasPanel.Panel.AddCloseButton();
        resoniteCanvasPanel.Panel.AddParentButton();
        resoniteCanvasPanel.Panel.Title = "Collider Management Wizard";
    ...
    private void CreateScrollListElement(MeshCollider mc)
    {
        ...
        _text = "Jump To";
        _listBuilder2.ButtonRef(in _text, JumpTo, mc.Slot);
        _text = "Highlight";
        _listBuilder2.ButtonRef(in _text, Highlight, mc.Slot);
        _text = "Replace";
        _listBuilder2.ButtonRef(in _text, Replace, mc);
        _text = "Remove";
        _listBuilder2.ButtonRef(in _text, Remove, mc);
    ...
    private void ReplaceAll(IButton button, ButtonEventData eventData)
    {
        if (CheckReplacementBoundsSetting())
        {
            ...
            // World.EndUndoBatch();
            PopulateList();
            ShowResults($"{_count} matching MeshColliders replaced with {replacementColliderComponent}s.");
        }
        else
        {
            ShowResults($"{replacementColliderComponent.Value.Value} cannot be used with {setupBoundsType.Value.Value}");
